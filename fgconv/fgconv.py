...
from fgconv.pointnet2 import pointnet2_utils
from fgconv.pointnet2 import pytorch_utils as pt_utils
from fgconv import base
relu_alpha = 0.2


class fgconv4x4_BaseBlock(nn.Module):
    def __init__(self, npoint, nsample, radius, in_channel, out_channel, bn=True, use_xyz=False):
        
        super().__init__()
        print('fgconv4x4 init:', npoint, nsample, radius, in_channel, out_channel)
        self.npoint = npoint
...
class fgconv6x6_BaseBlock(nn.Module):
    def __init__(self, npoint, nsample, radius, in_channel, out_channel, bn=True, use_xyz=False):

        super().__init__()
        print('fgconv6x6 init:', npoint, nsample, radius, in_channel, out_channel)
        self.npoint = npoint
        self.map_size = 6
