...
class Resnet_BaseBlock(nn.Module):
    def __init__(self, fgconv,
        ...
        self.conv2 = fgconv(npoint=npoint, 
                            nsample=nsample,
                            radius=radius,
    ...
    def forward(self, xyz, feats, new_xyz=None):
        ...
        if not self.keep_pcd: # not keep pcd, apply fgconv with fps
...
class AssemRes_BaseBlock(nn.Module):
    def __init__(self, CONV_BASE,
        ...
        for i in range(len(channel_list) - 1):
            ...
            self.conv_blocks.append(Resnet_BaseBlock(fgconv=CONV_BASE,
